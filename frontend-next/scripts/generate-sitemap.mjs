/**
 * Generates lib/seo/sitemap-xml.ts before build (served via app/sitemap/sitemap.xml/route.ts).
 */
...
`;
  ...
  const moduleOut = resolve(root, 'lib', 'seo', 'sitemap-xml.ts');
  ...
  console.log(`Wrote ${moduleOut} (${entries.length} URLs) for ${SITE_URL}`);
}
